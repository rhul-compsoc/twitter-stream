...
const VaporWave = ({
  ...
  <div>
    ...
    >
      ...
      <div
        className={`absolute top-12 flex w-full justify-center text-5xl ${css.glow}`}
      >
        {topBanner}
      </div>
      <div className={css.text}>
        <Image src={LightTheme} alt="Light Theme" width={1500} height={600} style={{ filter: 'drop-shadow(3px 3px 0px #FFFFFF) drop-shadow(5px 5px 0px #FFFFFF) drop-shadow(-5px -5px 0px #FFFFFF)drop-shadow(0px 0px 10px #FFFFFF)' }} />
      </div>
    </div>
